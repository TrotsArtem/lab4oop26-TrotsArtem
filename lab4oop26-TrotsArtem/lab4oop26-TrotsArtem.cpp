...
// ЗАВДАННЯ 2. Асоціативний клас (Електронна пошта -> ПІБ)
struct AccountPair {
    std::string email;
    std::string fullName;
};
...
// ЗАВДАННЯ 3. Матриці на основі Vector3D
class Vector3D {
public:
    int x, y, z;
...
// функція вибору типу заповнення даних
...
int main() {
    ...
    // Авто-генерація заготовок файлів
    {
